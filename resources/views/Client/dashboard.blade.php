...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li>
            <a  class="nav-link scrollto active" href="{{route('info')}}">Escale</a>
          </li>
          <li><a class="nav-link scrollto" href="{{route('Etat')}}">Etat</a></li>
  ...
  <div class="content">
      <h3 style="color: rgb(255, 0, 0);">Bonjour {{$getRecord->name}} en MARSA <span style="color: rgb(131, 126, 126);" >MAROC <span></h3>
